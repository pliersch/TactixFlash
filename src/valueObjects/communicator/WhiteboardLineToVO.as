package valueObjects.communicator {
	...
	public class WhiteboardLineToVO implements IExternalizable, ValueObject{
		
		private static const ALIAS:* = registerClassAlias( "WhiteboardLineToVO", WhiteboardLineToVO );
		private var _xCoord:int;
		private var _yCoord:int;

		public function WhiteboardLineToVO(xCoord:int=0,yCoord:int=0) {
			_xCoord = xCoord;
			_yCoord = yCoord;
		}
